...
def translate_text(text, target_language):
    ...
    prompt = f"Please translate '{text}' to {target_language}, without including any additional information or explanation or the user input. eg user: ¡Vale! your response: okay!, user: agba la gba ni mi your response: I am an old man,  user:  AGA MA TURU CHINEKE your response: Go and bless God"
